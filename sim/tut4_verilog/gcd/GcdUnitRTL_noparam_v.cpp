...
#include "obj_dir_GcdUnitRTL_noparam/VGcdUnitRTL_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_GcdUnitRTL_noparam/VGcdUnitRTL_noparam__Syms.h"
#include "svdpi.h"
#endif
...
VGcdUnitRTL_noparam_t * create_model( const char *vcd_filename ) {

  VGcdUnitRTL_noparam_t * m;
  VGcdUnitRTL_noparam   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VGcdUnitRTL_noparam_t *) malloc( sizeof(VGcdUnitRTL_noparam_t) );
  model = new VGcdUnitRTL_noparam();
...
void destroy_model( VGcdUnitRTL_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VGcdUnitRTL_noparam * model = (VGcdUnitRTL_noparam *) m->model;
...
void comb_eval( VGcdUnitRTL_noparam_t * m ) {
...
void seq_eval( VGcdUnitRTL_noparam_t * m ) {
...
#if VLINETRACE
void trace( VGcdUnitRTL_noparam_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_GcdUnitRTL_noparam__v );
